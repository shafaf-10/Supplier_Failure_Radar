...
def ensure_prediction_table_columns():
    ...
    required_cols = {
        ...
        "failure_rate": "DECIMAL(10,4) DEFAULT 0",
        "pending_rate": "DECIMAL(10,4) DEFAULT 0",
        "cancellation_rate": "DECIMAL(10,4) DEFAULT 0",
        "process_error_rate": "DECIMAL(10,4) DEFAULT 0",
        "refund_rate": "DECIMAL(10,4) DEFAULT 0",
        "credit_rejection_rate": "DECIMAL(10,4) DEFAULT 0",
        "search_failure_rate": "DECIMAL(10,4) DEFAULT 0",
        "wallet_risk_rate": "DECIMAL(10,4) DEFAULT 0",
    }
...
def load_features(features_df=None):
    ...
    if not FEATURE_FILE.exists():
        raise FileNotFoundError(
            ...
            "Run feature_builder.py or pipeline first."
        )
