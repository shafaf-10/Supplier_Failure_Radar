...
# def run_prediction_pipeline(days: int | None = 30):
#     """
#     Production pipeline:
...
#     drift_result = detect_feature_drift(features_df, features_df.columns.intersection(features_df.select_dtypes("number").columns).tolist())
