...
# def get_future_unavailability_target(df: pd.DataFrame) -> pd.Series:
#     label_column = "observed_service_unavailability_next_7d"

#     if label_column not in df.columns:
#         raise ValueError(
#             "observed_service_unavailability_next_7d column missing. "
#             "The future model requires future operational outcomes."
#         )
...
# ) -> pd.Series:
#     """
#     Build a present-state operational risk target.

#     This target uses only information available at the current
#     feature snapshot. It does not use future outcomes.
#     """
...
#     booking_problem = (
#         df["b_failure_rate"] >= 0.20
#     )

#     process_problem = (
#         (df["bp_error_rate"] >= 0.20)
#         | (df["bp_stuck_rate"] >= 0.25)
#         | (df["bp_high_retry_rate"] >= 0.25)
#     )

#     search_problem = (
#         (df["ss_failure_rate"] >= 0.20)
#         | (df["ss_timeout_rate"] >= 0.10)
#         | (df["ss_completion_gap_rate"] >= 0.20)
#     )

#     current_risk_signal_count = (
...
#         if class_names == ["CURRENTLY_STABLE", "CURRENTLY_AT_RISK"]:
...
#     if "observed_service_unavailability_next_7d" not in df.columns:
...
#     y_risk = get_current_operational_risk_target(df)
...
#         X_risk,
#         y_risk,
#         ["CURRENTLY_STABLE", "CURRENTLY_AT_RISK"],
...
#         "target": "current_operational_risk",
#         "prediction_horizon": "CURRENT_STATE",
#         "model_purpose": (
#             "Classify the supplier's current operational risk using "
#             "booking, process, search and transaction conditions "
#             "available at the feature snapshot."
#         ),
#     }
...
#     X_future = df[FEATURE_COLUMNS].fillna(0)

#     y_future = get_future_unavailability_target(df)

#     logger.info(
#         "Future unavailability target distribution: %s",
#         y_future.value_counts().to_dict(),
#     )

#     future_model_name, future_model, future_accuracy = (
...
#         "feature_columns": FEATURE_COLUMNS,
#         "target": "observed_service_unavailability_next_7d",
...
#         ],
#         "model_purpose": (
#             "Predict supplier service unavailability during the "
#             "next 7 days using information available at the "
...
#         "detection_scope": "CURRENT_STATE",
#         "prediction_horizon": None,
#         "model_purpose": (
#             "Detect unusual supplier behaviour in the current "
#             "feature snapshot. This model does not predict "
#             "future service unavailability."
#         ),
#     }
